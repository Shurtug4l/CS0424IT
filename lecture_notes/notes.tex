\documentclass[english,course,openright]{lecture}
...
\include{units/unit1/S1L1}
\include{units/unit1/S1L2L3L4}
\include{units/unit1/S2L1}
\include{units/unit1/S2L2}
\include{units/unit1/S2L3}
